...
# run_experiment_for_dataset('itc2007_track3',select_t3_datasets[3:] , 'select with valid dfs construction and 150 generations with gsga', 1, {'population_size': 50, 'no_of_generations': 150, 'first_population_method': "dfs",'crossover_chance': 0.8, 'crossover_ratio': 0.5, 'mutation_chance': 0.5,'guided_search':True,'local_search':True})


# In[ ]:


run_experiment_for_dataset('itc2019', select_2019_datasets[3:],
                           'select with valid dfs construction and 150 generations with gsga', 1,
                           {'population_size': 50, 'no_of_generations': 150, 'first_population_method': "dfs",
                            'crossover_chance': 0.8, 'crossover_ratio': 0.5, 'mutation_chance': 0.5,
                            'guided_search': True, 'local_search': True})
